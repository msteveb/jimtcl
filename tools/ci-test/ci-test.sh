...
make -C $SRC_DIR/tests jimsh="valgrind --leak-check=full --show-reachable=yes --error-exitcode=1 --suppressions=$SRC_DIR/tools/ci-test/valgrind.supp $BUILD_DIR/jimsh" TOPSRCDIR=$SRC_DIR
